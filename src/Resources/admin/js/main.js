...
var _Sidebar = require('./Sidebar/Sidebar.vue');

var _Sidebar2 = _interopRequireDefault(_Sidebar);

var _License = require('./Partials/License.vue');

var _License2 = _interopRequireDefault(_License);

var _CheckAssetsVersion = require('./Partials/CheckAssetsVersion.vue');

var _CheckAssetsVersion2 = _interopRequireDefault(_CheckAssetsVersion);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
    init: function init(layout) {
        ...
        return {
            ...
            components: { Sidebar: _Sidebar2.default, License: _License2.default, CheckAssetsVersion: _CheckAssetsVersion2.default },
            ...
            methods: {
                openAlert: function openAlert(title, message, type, success, close) {
                ...
                checkAlertEvents: function checkAlertEvents() {
                    ...
                    $(window).keyup(function (e) {
                        ...
                        //If is opened alert
                        if (_this.canShowAlert !== true) return;

                        if (e.keyCode == 13) _this.closeAlert(_this.alert.success || _this.alert.close);

                        if (e.keyCode == 27) _this.closeAlert(_this.alert.close);
                    });
                },
                ...
                errorResponseLayer: function errorResponseLayer(response, code, callback) {
                    ...
                    if ('responseJSON' in response) response.data = response.responseJSON;
                    ...
                    //Callback on code
                    if (callback && (code === response.status || code === null)) return callback(response);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-24724608", module.exports)
  } else {
    hotAPI.update("_v-24724608", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./Partials/CheckAssetsVersion.vue":110,"./Partials/License.vue":112,"./Sidebar/Sidebar.vue":116,"vue":104,"vue-hot-reload-api":78}],106:[function(require,module,exports){
'use strict';
...
var _FormInputBuilder = require('../Forms/FormInputBuilder.vue');

var _FormInputBuilder2 = _interopRequireDefault(_FormInputBuilder);
...
exports.default = {
  ...
  computed: {
    title: function title() {
      ...
      //Insert title
      if (title = this.$root.getModelProperty(this.model, 'settings.title.insert')) return title;
    ...
    newRowTitle: function newRowTitle() {
      ...
      if (title = this.$root.getModelProperty(this.model, 'settings.buttons.insert')) return title;

      return 'nový záznam';
    },
    chunkGroups: function chunkGroups() {
      var groups = (0, _keys2.default)(this.model.fields_groups),
          chunkSize = 2,
          data = [];
  ...
  methods: {
    //Return group class
    getGroupClass: function getGroupClass(group_name) {
      if (this.getGroup(group_name).width == 'half') return 'col-md-6';
    ...
    canShowGroupName: function canShowGroupName(group_name) {
    ...
    sendForm: function sendForm(e, action, callback) {
      ...
      if (action == 'update') {
        ...
        if (this.$root.language_id != null) data['language_id'] = this.$root.language_id;
      }
        ...
        error: function error(response) {
          ...
          _this.$root.errorResponseLayer(response, 422, function () {
            ...
            for (var key in obj) {
              ...
              if (typeof obj[key] == 'string') array = [obj[key]];else array = obj[key];
              ...
              for (var i = 0; i < array.length; i++) {
                for (var a = 0; a <= 1; a++) {
                  ...
                  _this.form.find('input[name="' + key + '"], select[name="' + key + '"], textarea[name="' + key + '"]').each(function () {
                    ...
                    if (where) where.after('<span class="help-block">' + array[i] + '</span>');
  ...
  components: { FormInputBuilder: _FormInputBuilder2.default }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3df264da", module.exports)
  } else {
    hotAPI.update("_v-3df264da", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Forms/FormInputBuilder.vue":107,"babel-runtime/core-js/object/keys":2,"vue":104,"vue-hot-reload-api":78}],107:[function(require,module,exports){
'use strict';
...
var _File = require('../Partials/File.vue');
...
exports.default = {
  ...
  filters: {
    languageOptions: function languageOptions(array) {
  ...
  events: {
    onSubmit: function onSubmit(row) {
      if (this.file_from_server == true && row != null) return;
  ...
  methods: {
    updateField: function updateField(field) {
      ...
      if (field.type == 'file') this.file_from_server = true;
    ...
    removeFile: function removeFile() {
      if (!this.isMultiple) this.field.value = null;
    ...
    selectIndex: function selectIndex(select, index) {
      this.updateSelect = true;

      if (this.updateSelectTimeout) clearTimeout(this.updateSelectTimeout);

      this.updateSelectTimeout = setTimeout(function () {
        var select = $('#' + this.getId).trigger("chosen:updated");

        if (this.isSelect && this.isMultiple) {
          if (this.value) select.setSelectionOrder(this.value);
    ...
    rebuildSelect: function rebuildSelect() {
      ...
      if (!(this.isSelect && this.isMultiple)) return;

      var select = $('#' + this.getId),
          fake_select = select.prev(),
          values = select.getSelectionOrder();

      if (!fake_select.is('select')) fake_select = select.before('<select name="' + this.key + '[]" multiple="multiple" style="display: none"></select>').prev();
  ...
  computed: {
    getId: function getId() {
      var parent = 'getParentTableName' in this.$parent.$parent ? this.$parent.$parent.getParentTableName() : this.$parent.$parent.$parent.getParentTableName();
    ...
    uploadSelectPluginAfterLoad: function uploadSelectPluginAfterLoad() {
      this.field.value;
     ...
     */
    getLangageId: function getLangageId() {
    ...
    missingValueInSelectOptions: function missingValueInSelectOptions() {
      if (!this.row || this.isMultiple || this.isMultipleUpload) return false;
      ...
      for (var i = 0; i < options.length; i++) {
        if (options[i][0] == this.field.value) return false;
      }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-fd1c34ae", module.exports)
  } else {
    hotAPI.update("_v-fd1c34ae", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Partials/File.vue":111,"vue":104,"vue-hot-reload-api":78}],108:[function(require,module,exports){
'use strict';
...
var _FormBuilder = require('./FormBuilder.vue');

var _FormBuilder2 = _interopRequireDefault(_FormBuilder);

var _ModelRowsBuilder = require('./ModelRowsBuilder.vue');
...
exports.default = {
  ...
  data: function data() {
    return {
      sizes: [{ size: 8, key: 'small', name: 'Small', active: false, disabled: false }, { size: 6, key: 'medium', name: 'Medium', active: false, disabled: false }, { size: 3, key: 'big', name: 'Big', active: false, disabled: false }, { size: 0, key: 'full', name: 'Full width', active: false, disabled: false }],
  ...
  watch: {
      ...
      handler: function handler(data) {
        this.activeSize = data.filter(function (row) {
          ...
          if (row.active == true) {
            ...
            localStorage.sizes = (0, _stringify2.default)(rows);
          }
    ...
    parentrow: function parentrow(row) {
  ...
  filters: {
     ...
     */
    languageOptions: function languageOptions(array, langid) {

      //Checks if values are devided by language
      var localization = false;

      for (var key in array) {
        if (array[key][1] !== null && (0, _typeof3.default)(array[key][1]) === 'object') {
          localization = true;
          break;
        }
      }
     ...
     */
    positionLayout: function positionLayout(array, position) {
  ...
  events: {
    ...
    proxy: function proxy(name, param) {
  ...
  methods: {
    ...
    getParentTableName: function getParentTableName() {
    ...
    checkActiveSize: function checkActiveSize(columns) {
      ...
      //Full screen
      if (columns.length > 5) return this.sizes[3].active = true;

      //Big
      if (columns.length <= 1) return this.sizes[2].active = true;

      //Small
      if (columns.length == 5) return this.sizes[0].active = true;
    ...
    saveLanguageFilter: function saveLanguageFilter(rows) {
    ...
    getSearchingColumnName: function getSearchingColumnName(column) {
      if (column == 'id') return 'ID. (č.)';

      if (!column || !(column in this.model.fields)) return 'Hľadať všade';
  ...
  computed: {
    getFilterSelectId: function getFilterSelectId() {
    ...
    isEnabledGrid: function isEnabledGrid() {
      if (this.$root.getModelProperty(this.model, 'settings.grid.enabled') === false) return false;
    ...
    canAddRow: function canAddRow() {
      ...
      if (this.model.insertable == false) return false;
    ...
    getSearchableFields: function getSearchableFields() {
      ...
      for (var key in this.model.fields) {
        ...
        if ('belongToMany' in field || 'multiple' in field || 'removeFromForm' in field && 'hidden' in field) continue;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-373c13f4", module.exports)
  } else {
    hotAPI.update("_v-373c13f4", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./FormBuilder.vue":106,"./ModelRowsBuilder.vue":109,"babel-runtime/core-js/json/stringify":1,"babel-runtime/helpers/typeof":5,"vue":104,"vue-hot-reload-api":78}],109:[function(require,module,exports){
'use strict';
...
var _Refreshing = require('../Partials/Refreshing.vue');

var _Refreshing2 = _interopRequireDefault(_Refreshing);

var _TableRows = require('../Partials/TableRows.vue');
...
exports.default = {
  ...
  events: {
     ...
     */
    onCreate: function onCreate(array) {
      ...
      //If user is not on lage page, then change page into last, for see added rows
        ...
        //If row can be pushed without reloading rows into first or last page
            ...
            if (rows.length > this.pagination.limit) rows = rows.slice(0, this.pagination.limit);
     ...
     */
    onUpdate: function onUpdate(array) {
      if (array[0] != this.model.slug) return;
  ...
  computed: {
    ...
    rowsData: function rowsData() {
      return this.rows.data.sort(function (a, b) {
        ...
        a = a[this.orderBy[0]] + '', b = b[this.orderBy[0]] + '';

        //Sorting numbers
        if (this.isNumericValue(this.orderBy[0])) {
          if (this.orderBy[1] == 1) return b - a;

          return a - b;
        } else {
          if (this.orderBy[1] == 1) return b.toLowerCase().localeCompare(a.toLowerCase(), 'sk');
  ...
  methods: {
    ...
    loadRows: function loadRows(indicator) {
      if (indicator !== false) this.pagination.refreshing = true;
    ...
    initTimeout: function initTimeout(indicator) {
      this.destroyTimeout();

      //Disable autorefreshing when is one row
      if (this.rows.count > 0 && this.model.maximum === 1) return;

      this.updateTimeout = setTimeout(function () {
        this.loadRows(indicator);
      }.bind(this), this.refresh.interval);
    },
    updateFieldOptions: function updateFieldOptions(fields) {
      //Update fields from database, for dynamic selectbox values
      for (var key in fields) {
        if ('options' in this.model.fields[key] && (0, _keys2.default)(fields[key].options).length > 0) {
    ...
    setOrder: function setOrder() {
      ...
      if (this.orderBy == null) {
        ...
        if (orderBy) {
          var keys = (0, _keys2.default)(orderBy);
    ...
    showLimit: function showLimit(i) {
      ...
      if (this.rows.count / this.pagination.limit === max) max--;
      ...
      if (this.pagination.position - offset >= i + this.pagination.maxpages / 2 || this.pagination.position <= i - this.pagination.maxpages / 2 - offset) return false;
     ...
     */
    updateRowsData: function updateRowsData(data) {
      ...
      for (var i in this.rows.data) {
        ...
        if (this.row && this.row.id == data[i].id) continue;
...
exports.default = {
    ...
    ready: function ready() {
        ...
        if (this.hasLoadedLicense) {
            ...
            this.$http.get(this.address).then(function (response) {
                ...
                response.key = this.$root.license_key, this.setLicense(response, true);
    ...
    computed: {
        ...
        address: function address() {
            return 'http' + (this.isDev ? '' : 's') + '://' + this.domain + this.path.reverse().join('').replace(':version', this.$root.version).replace(':key', this.$root.license_key).replace(':domain', location.host);
        },
    ...
    methods: {
        setLicense: function setLicense(response, save) {
            if (save === true) localStorage.authentication = (0, _stringify2.default)(response);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4663bff8", module.exports)
  } else {
    hotAPI.update("_v-4663bff8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/json/stringify":1,"vue":104,"vue-hot-reload-api":78}],113:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4d743040", module.exports)
  } else {
    hotAPI.update("_v-4d743040", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
        ...
        if (this.model.fields[field].type == 'select' || isRadio) {
          if ('multiple' in this.model.fields[field] && this.model.fields[field].multiple == true && $.isArray(row[field]) && !isRadio) {
            ...
            for (var i = 0; i < rows.length; i++) {
              if (rows[i] in this.getLanguageSelectOptions(this.model.fields[field].options)) values.push(this.getLanguageSelectOptions(this.model.fields[field].options)[rows[i]]);
            }
            ...
            if (!options) return row[field];

            for (var i = 0; i < options.length; i++) {
              if (row[field] == options[i][0]) return options[i][1];
            }
          }
  ...
  methods: {
    getLanguageSelectOptions: function getLanguageSelectOptions(array) {
    ...
    isFile: function isFile(field) {
      ...
      if (this.model.fields[field].type == 'file') return true;

      return false;
    },
    getFiles: function getFiles(row, field) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-97ae2fc8", module.exports)
  } else {
    hotAPI.update("_v-97ae2fc8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Partials/File.vue":111,"vue":104,"vue-hot-reload-api":78}],115:[function(require,module,exports){
'use strict';
...
var _TableRowValue = require('./TableRowValue.vue');

var _TableRowValue2 = _interopRequireDefault(_TableRowValue);
...
exports.default = {
  ...
  components: { TableRowValue: _TableRowValue2.default },
  ...
  created: function created() {
    ...
    if (this.model.foreign_column != null) this.hidden.push(this.model.foreign_column);
  ...
  computed: {
    ...
    avaliableColumns: function avaliableColumns() {
      return ['id'].concat((0, _keys2.default)(this.model.fields));
    },
  ...
  methods: {
    ...
    buttonAction: function buttonAction(key, button, row) {
      ...
      this.$http.post(this.$root.requests.buttonAction, {
        ...
        if ('data' in data) {
          ...
          //Redirect on page
          if ('redirect' in data.data && data.data.redirect) window.location.replace(data.data.redirect);
        }
    ...
    findById: function findById(id) {
      for (var key in this.rowsdata) {
        if (this.rowsdata[key].id == id) return this.rowsdata[key];
      }
    },
    ...
    enableDraggind: function enableDraggind() {
      this.$parent.initTimeout(false);
      this.dragging = false;
    },
    updateOrder: function updateOrder(dragged, dropped) {
      ...
      this.$http.post(this.$root.requests.updateOrder, { model: this.model.slug, rows: rows }).then(function (response) {
    ...
    showInfo: function showInfo(row) {
      ...
      if (row.created_at != null) data += 'Vytvorené dňa: <strong>' + this.$root.timeFormat(row.created_at) + '</strong><br>';

      if (row.updated_at != null && this.model.editable != false) data += 'Posledná zmena: <strong>' + this.$root.timeFormat(row.updated_at) + '</strong><br>';

      if (row.published_at != null) data += 'Publikované dňa: <strong>' + this.$root.timeFormat(row.published_at) + '</strong>';

      this.$root.openAlert('Informácie o zázname č. ' + row.id, data, 'primary', null, function () {});
    },
    selectRow: function selectRow(row, data, model) {
      ...
      if (data) {
        ...
        this.$http.get(this.$root.requests.show, { model: this.model.slug, id: row.id }).then(function (response) {
    ...
    removeRow: function removeRow(row) {
      var success = function () {
        ...
        //Check if is enabled language
        if (this.$root.language_id != null) data['language_id'] = parseInt(this.$root.language_id);

        this.$http.post(this.$root.requests.delete, data).then(function (response) {
          var data = response.data;
          ...
          if (this.row && this.row.id == row.id) this.row = null;
        }).catch(function (response) {
          this.$root.errorResponseLayer(response);
        });
      }.bind(this);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7ef337be", module.exports)
  } else {
    hotAPI.update("_v-7ef337be", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./TableRowValue.vue":114,"babel-runtime/core-js/object/keys":2,"vue":104,"vue-hot-reload-api":78}],116:[function(require,module,exports){
'use strict';
...
var _SidebarRow = require('./SidebarRow.vue');

var _SidebarRow2 = _interopRequireDefault(_SidebarRow);
...
exports.default = {
    ...
    ready: function ready() {
        ...
        if (owner.hasClass('treeview')) owner.addClass('active');
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-74a64ce5", module.exports)
  } else {
    hotAPI.update("_v-74a64ce5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./SidebarRow.vue":117,"vue":104,"vue-hot-reload-api":78}],117:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0901ade5", module.exports)
  } else {
    hotAPI.update("_v-0901ade5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":104,"vue-hot-reload-api":78}],118:[function(require,module,exports){
'use strict';
...
var _ModelBuilder = require('../Forms/ModelBuilder.vue');
...
exports.default = {
  ...
  components: { ModelBuilder: _ModelBuilder2.default }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-56a2ff9a", module.exports)
  } else {
    hotAPI.update("_v-56a2ff9a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Forms/ModelBuilder.vue":108,"vue":104,"vue-hot-reload-api":78}],119:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0278ed58", module.exports)
  } else {
    hotAPI.update("_v-0278ed58", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":104,"vue-hot-reload-api":78}],120:[function(require,module,exports){
'use strict';
...
var _DashboardView = require('./components/views/DashboardView.vue');

var _DashboardView2 = _interopRequireDefault(_DashboardView);

var _BasePageView = require('./components/views/BasePageView.vue');

var _BasePageView2 = _interopRequireDefault(_BasePageView);
 ...
 */
(function () {
    Vue.http.options.root = $('meta[name="root"]').attr('content'), Vue.http.options.headers = {
...
Vue.http.get('api/layout').then(function (response) {
    ...
    for (var key in layout.models) {
        ...
        for (var i = 0; i < models.length; i++) {
            ...
            if (models[i].active == false) continue;
            ...
            routes['/' + models[i].slug] = {
                ...
                component: {
                    ...
                    //Subkomponenta
                    components: { BasePageView: _BasePageView2.default }
                }
            };
        }
    }
    ...
    var app = Vue.extend(_BaseComponent2.default.init(layout));
...
},{"./components/BaseComponent.vue":105,"./components/views/BasePageView.vue":118,"./components/views/DashboardView.vue":119,"jquery-form/jquery.form.js":75,"vue":104,"vue-drag-and-drop":77,"vue-resource":92,"vue-router":103}]},{},[120]);
