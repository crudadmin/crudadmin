...
exports.default = {
    init: function init(layout) {
        ...
        return {
            ...
            components: { Sidebar: _Sidebar2.default, License: _License2.default },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-16e8de7c", module.exports)
  } else {
    hotAPI.update("_v-16e8de7c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./Partials/License.vue":111,"./Sidebar/Sidebar.vue":115,"vue":104,"vue-hot-reload-api":78}],106:[function(require,module,exports){
'use strict';
              ...
              for (var i = 0; i < array.length; i++) {
                for (var a = 0; a <= 1; a++) {
                  ...
                  _this.form.find('input[name="' + key + '"], select[name="' + key + '"], textarea[name="' + key + '"]').each(function () {
                    ...
                    if ($(this).is('select') || $(this).is('textarea')) where = where.parent().children().last().prev();

                    where.after('<span class="help-block">' + array[i] + '</span>');

                    if (i == 0) $(this).parent().addClass('has-error').find('label').prepend('<i class="fa fa-times-circle-o"></i> ');
                  });
                }
              }
            }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-19a82b4d", module.exports)
  } else {
    hotAPI.update("_v-19a82b4d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-75880c2f", module.exports)
  } else {
    hotAPI.update("_v-75880c2f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Partials/File.vue":110,"vue":104,"vue-hot-reload-api":78}],108:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  data: function data() {
    ...
    return {
      sizes: [{ size: 8, name: 'Small', active: false, disabled: false }, { size: 6, name: 'Medium', active: false, disabled: false }, { size: 3, name: 'Big', active: false, disabled: false }, { size: 0, name: 'Full width', active: false, disabled: false }],
  ...
  filters: {
    ...
    languageOptions: function languageOptions(array) {
      ...
      for (var key in array) {
        if (array[key] !== null && (0, _typeof3.default)(array[key]) === 'object') {
          localization = true;
          break;
        }
      }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-802760e8", module.exports)
  } else {
    hotAPI.update("_v-802760e8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
  ...
  methods: {
    ...
    isNumericValue: function isNumericValue(key) {
      ...
      if (['integer', 'decimal', 'checkbox'].indexOf(this.model.fields[key].type) > -1) return true;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-06bdbf8f", module.exports)
  } else {
    hotAPI.update("_v-06bdbf8f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-14ba7a04", module.exports)
  } else {
    hotAPI.update("_v-14ba7a04", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/json/stringify":1,"vue":104,"vue-hot-reload-api":78}],112:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3995f10c", module.exports)
  } else {
    hotAPI.update("_v-3995f10c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":104,"vue-hot-reload-api":78}],113:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  filters: {
    stringLimit: function stringLimit(string, key) {
      if (!(key in this.model.fields)) return string;
      ...
      if (field in this.model.fields) {
        if (this.model.fields[field].type == 'select') {
          if ('multiple' in this.model.fields[field] && this.model.fields[field].multiple == true && $.isArray(row[field])) {
            ...
            if (row[field] in this.getLanguageSelectOptions(this.model.fields[field].options)) return this.getLanguageSelectOptions(this.model.fields[field].options)[row[field]];
          }
        }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-af81e2bc", module.exports)
  } else {
    hotAPI.update("_v-af81e2bc", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Partials/File.vue":110,"babel-runtime/helpers/typeof":5,"vue":104,"vue-hot-reload-api":78}],114:[function(require,module,exports){
'use strict';
      ...
      if (columns) {
        for (var i in columns) {
          ...
          for (var key in data) {
            ...
            if (columns) for (var k in columns) {
              if ('before' in columns[k] && columns[k].before == key) modifiedData[k] = columns[k].title;
            }
            ...
            if (columns) for (var k in columns) {
              if ('after' in columns[k] && columns[k].after == key) modifiedData[k] = columns[k].title;
            }
          }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5a7d9144", module.exports)
  } else {
    hotAPI.update("_v-5a7d9144", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./TableRowValue.vue":113,"babel-runtime/core-js/object/keys":2,"vue":104,"vue-hot-reload-api":78}],115:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-b8d05dc2", module.exports)
  } else {
    hotAPI.update("_v-b8d05dc2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./SidebarRow.vue":116,"vue":104,"vue-hot-reload-api":78}],116:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-36e7f12a", module.exports)
  } else {
    hotAPI.update("_v-36e7f12a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":104,"vue-hot-reload-api":78}],117:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-322d5920", module.exports)
  } else {
    hotAPI.update("_v-322d5920", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../Forms/ModelBuilder.vue":108,"vue":104,"vue-hot-reload-api":78}],118:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d6f73ee4", module.exports)
  } else {
    hotAPI.update("_v-d6f73ee4", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":104,"vue-hot-reload-api":78}],119:[function(require,module,exports){
'use strict';
...
},{"./components/BaseComponent.vue":105,"./components/views/BasePageView.vue":117,"./components/views/DashboardView.vue":118,"jquery-form/jquery.form.js":75,"vue":104,"vue-drag-and-drop":77,"vue-resource":92,"vue-router":103}]},{},[119]);
