...
return [
    ...
    */
    ...
    'after_or_equal'       => 'Dátum musí byť väčší alebo rovný dátumu :date.',
    ...
    'before_or_equal'      => 'Dátum musí byť menší alebo rovný dátumu :date.',
    'between'              => [
    ...
    'confirmed'            => 'Zadané hesla sa nezhoduju.',
    ...
    'email'                => 'Pole musí byť vo formáte emailu.',
    'exists'               => 'Zadaná hodnota v databáze neexistuje.',
    'file'                 => 'Pole musí byť vo formate súbrou.',
    'filled'               => 'Pole je požadované.',
    ...
    'min'                  => [
        'numeric' => 'Minimálna hodnota poľa je :min.',
        'file'    => ':attribute musí mať aspoň :min kilobajtov.',
        'string'  => 'Pole musí mať aspoň :min znakov.',
    ...
    'required_unless'      => 'Pole je povinné.',
    'required_with'        => 'Pole je povinné',
    'required_with_all'    => 'Pole je povinné',
    'required_without'     => 'Pole je povinné.',
    'required_without_all' => 'Pole je povinné.',
