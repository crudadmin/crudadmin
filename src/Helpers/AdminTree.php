...
class AdminTree
{
    public function get($initialRequest = false)
    {
        ...
        foreach ($models as $model) {
            ...
            $page = $this->makePage($model, true, $initialRequest);
     ...
     */
    private function getLayouts($model)
    {
        $layouts = [];
     ...
     */
    private function addSlugPath($pages)
    {
        $data = [];
