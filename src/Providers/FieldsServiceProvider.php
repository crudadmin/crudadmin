...
class FieldsServiceProvider extends ServiceProvider
{
    protected $allFields = [
        ...
        'invisible', 'inaccessible', 'component', 'sub_component', 'column_component', 'column_name', 'phone_link', 'ifExists', 'ifDoesntExists', 'hideOnUpdate', 'hideOnCreate', 'keepInRequest',
